...
//	}	
	...
	if(Voltage>40)
	{
		...
		{
			sinTable[n] =n*2*Voltage/tableSize+65;	
		}
		for(n=tableSize/2;n<tableSize;n++)
		{
			sinTable[n] =Voltage-(2*n+2-tableSize)*Voltage/tableSize+65;	
		}
	}
	if((Voltage<=40)&&(Voltage>=10))
	{
		for(n=0;n<tableSize/2;n++)
		{
			sinTable[n] =n*2*Voltage/tableSize+90;	
		}
		for(n=tableSize/2;n<tableSize;n++)
		{
			sinTable[n] =Voltage-(2*n+2-tableSize)*Voltage/tableSize+90;	
		}
	}
	if(Voltage==0)
	{
		for(n=0;n<tableSize/2;n++)
		{
			sinTable[n] =n*2*Voltage/tableSize+105;	
		}
		for(n=tableSize/2;n<tableSize;n++)
		{
			sinTable[n] =Voltage-(2*n+2-tableSize)*Voltage/tableSize+105;	
		}
	}
